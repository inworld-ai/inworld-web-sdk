...
import { RPMPhonemesToVisemesMap } from './RPMPhonemesToVisemesMap';

const SMOOTH_FACTOR_S = 0.15;
const LAST_PHONEME_DURATION = 1;
const EXPRESSION_FACTOR = 0.5;

export const RPMPhonemDataToViseme = function (
  offset: number,
  ...
  for (
    ...
    const currentViseme = RPMPhonemesToVisemesMap[currentPhoneme] ?? 0;
