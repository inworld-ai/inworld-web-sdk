...
export const InnequinPhonemesToVisemesMap: {
  ...
  j: 12, // ??? recheck
  k: 5,
  e: 4, // ??? no mapping in documentation 4,6 recommended
  ᵻ: 6, // ??? no mapping in documentation 4,6 recommended
  a: 1, // ??? no mapping in documentation 1 recommended
  o: 4, // ??? no mapping in documentation 8,4 recommended
  l: 8,
  m: 1,
  n: 8,
  ŋ: 5, // ???
